...
const weekendActivities: Record<string, ActivitySuggestion[]> = {
  Séoul: [
    ...
    { title: "Marche et street food", description: "Gwangjang Market pour un format facile en soirée de weekend.", sourceLabel: "Visit Séoul", sourceUrl: "https://english.visitseoul.net/attractions", coordinates: [37.5701, 126.9997] },
    { title: "Vue et sortie nocturne", description: "N Séoul Tower, Myeongdong ou Hongdae selon l'energie.", sourceLabel: "Visit Séoul", sourceUrl: "https://english.visitseoul.net/attractions", coordinates: [37.5512, 126.9882] },
  ],
  Tokyo: [
  ...
  "Hong Kong": [
    { title: "Victoria Peak", description: "Vue skyline, à placer si la météo est degagee.", sourceLabel: "Discover Hong Kong", sourceUrl: "https://www.discoverhongkong.com/eng/index.html", coordinates: [22.2759, 114.1455] },
  ...
  Jakarta: [
    { title: "Monas et Merdeka Square", description: "Point de repere central, facile à combiner avec les monuments voisins.", sourceLabel: "Travel Lush", sourceUrl: "https://travel-lush.com/9-things-to-do-jakarta/", coordinates: [-6.1754, 106.8272] },
  ...
  Kinmen: [
    { title: "Juguang Tower et patrimoine militaire", description: "Introduction rapide à l'histoire particuliere de Kinmen.", sourceLabel: "Kinmen Travel", sourceUrl: "https://kinmen.travel/en/discover/travel-guide", coordinates: [24.4304, 118.3176] },
    { title: "Zhaishan Tunnel", description: "Site militaire souterrain, très adapté à un court séjour.", sourceLabel: "Taiwan Tourism", sourceUrl: "https://eng.taiwan.net.tw/m1.aspx?sno=0043590", coordinates: [24.4094, 118.3097] },
  ...
  Okinawa: [
    { title: "Kokusai-dori a Naha", description: "Base simple pour shopping, repas et première soirée.", sourceLabel: "Visit Okinawa Japan", sourceUrl: "https://visitokinawajapan.com/", coordinates: [26.2147, 127.6841] },
    { title: "Shuri / patrimoine ryukyu", description: "Patrimoine culturel à combiner avec Naha si le weekend est court.", sourceLabel: "Visit Okinawa Japan", sourceUrl: "https://visitokinawajapan.com/", coordinates: [26.217, 127.7193] },
    { title: "Aquarium ou plage", description: "Option journée selon transport: Churaumi Aquarium, Manza Beach ou cote ouest.", sourceLabel: "Expedia Okinawa", sourceUrl: "https://www.expedia.com/Things-To-Do-In-Okinawa-Island.d10805.Travel-Guide-Activities", coordinates: [26.6942, 127.878] },
  ],
  Osaka: [
    ...
    { title: "Osaka Castle Park", description: "Classique historique et parc facile à integrer dans une demi-journée.", sourceLabel: "Japan Travel Osaka", sourceUrl: "https://www.japan.travel/en/destinations/kansai/osaka/", coordinates: [34.6873, 135.5262] },
...
function createWeekendSteps(seed: WeekendSeed): Trip["steps"] {
  ...
  const cityCenterStep: Trip["steps"][number] = {
    ...
    dailyPlan: [
      ...
      { date: "Jour 2", summary: `Journée complete centrée sur ${seed.city}: quartiers, activites et repas locaux.` },
  ...
  const activitySteps: Trip["steps"] = activities.map((activity, index) => ({
    ...
    endDate: seed.endDate,
    nights: "Point à voir",
    transport: `Sur place pendant le weekend à ${seed.city}.`,
