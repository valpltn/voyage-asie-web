...
Connecte-toi dans le site, ouvre le panneau `Modifier`, puis sauvegarde les voyages/dépenses que tu veux pousser vers Supabase. La v1 utilise du JSON valide par Zod pour limiter les requetes et garder un schema simple.
